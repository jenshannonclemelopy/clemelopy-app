...
import { projectTourSteps } from '../../components/projectTourSteps';
...
export default function ProjectView() {
  ...
  // Project page tour
  const { showTour, hasCompletedTour, startTour, closeTour, completeTour } = usePageTour('project', true);
      ...
      <Layout activeNav="my-projects">
        <div className="flex items-center justify-center py-20" role="status" aria-live="polite">
          <div className="text-center">
            <div className="w-16 h-16 border-4 border-[#0D7871] border-t-transparent rounded-full animate-spin mx-auto mb-4" aria-hidden="true"></div>
            <p className="text-[#4a4642]" style={{ fontFamily: 'Inter', fontWeight: 500 }}>
              Loading project...
            </p>
          </div>
        </div>
    ...
    return (
      <Layout activeNav="my-projects">
        <div className="flex items-center gap-2 text-sm mb-6 -mt-2" style={{ fontFamily: 'Inter', fontWeight: 500 }}>
          <a href="/my-projects" className="text-[#006b63] hover:text-[#0D7871] transition-colors">My Projects</a>
          <span className="text-[#6b6560]">→</span>
          <span className="text-[#4a4642]">Error</span>
        </div>
        <div 
          style={{
  ...
  return (
    <Layout activeNav="my-projects">
      ...
      <main id="project-main" role="main">
        {/* Breadcrumb and Tour Button */}
        <div className="flex items-center justify-between mb-6">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm" style={{ fontFamily: 'Inter', fontWeight: 500 }}>
            <a href="/my-projects" className="text-[#006b63] hover:text-[#0D7871] transition-colors">My Projects</a>
            <span className="text-[#6b6560]" aria-hidden="true">→</span>
            <span className="text-[#4a4642]" aria-current="page">{getProjectName()}</span>
          </nav>
        ...
        <div style={{ 
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <section data-tour="pdf-preview" style={{ ...glassCard, borderRadius: '24px', overflow: 'hidden' }} aria-labelledby="pdf-preview-heading">
              ...
              >
                <h2 id="pdf-preview-heading" className="text-white font-semibold flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates' }}>
          ...
          <div className="flex flex-col gap-6">
            {/* Project Info Card */}
            <div data-tour="project-info" style={glassCard} className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  {isEditingName ? (
                    ...
                    <div className="flex items-center gap-3">
                      <h1 className="text-2xl text-[#1a1a1a]" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 700 }}>
                        {getProjectName()}
                      </h1>
                      <button 
                        onClick={() => setIsEditingName(true)} 
                        className="p-1.5 text-[#6b6560] hover:text-[#0d7871] hover:bg-[#FAA819]/10 rounded-lg transition"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button 
                  ...
                  className="p-2 text-[#6b6560] hover:text-red-500 hover:bg-red-50 rounded-lg transition"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="grid grid-cols-1 gap-4 pt-4" style={{ borderTop: '1px solid rgba(255, 255, 255, 0.4)' }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-[#6b6560]" style={{ fontFamily: 'Inter', fontWeight: 500 }}>Created</p>
                    <p className="text-sm text-[#1a1a1a] font-medium" style={{ fontFamily: 'Inter' }}>{formatDate(project.created_at)}</p>
                  </div>
                </div>
                ...
                {project.source_url && (
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs text-[#6b6560]" style={{ fontFamily: 'Inter', fontWeight: 500 }}>Source URL</p>
                      <a 
                        href={project.source_url} 
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="text-sm text-[#006b63] hover:text-[#0D7871] font-medium truncate block transition" 
                    ...
                    <button 
                      ...
                      className="p-2 text-[#6b6560] hover:text-[#006b63] hover:bg-[#00A99D]/10 rounded-lg transition"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Orchard Ecosystem Framework CTA */}
            <a 
              href="/learn" 
              data-tour="orchard-framework"
              className="flex-1 block p-8 rounded-3xl relative overflow-hidden"
              style={{
            ...
            >
              <div className="relative flex flex-col items-center justify-center h-full text-center">
                <img 
                  ...
                  alt="Orchard Ecosystem Framework" 
                ...
                >
                  ...
                  {' '}
                  <span style={{ color: '#1a1a1a' }}>Framework™</span>
                </h3>
                <p className="text-base text-[#4a4642] mb-6 max-w-sm" style={{ fontFamily: 'Inter', fontWeight: 500 }}>
                  Learn how each element in your strategy fits into the bigger picture
                </p>
                <div 
          ...
          <div className="mt-8">
            ...
            <div style={{ ...glassCard, borderRadius: '24px', overflow: 'hidden' }}>
              {/* Tab Navigation */}
              <div className="flex" style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.4)' }} role="tablist">
                <button 
                  ...
                  style={{ 
                    ...
                    background: activeTab === 'overview' 
                      ...
                      : 'transparent',
                    color: activeTab === 'overview' ? 'white' : '#4a4642',
                  }}
                >
                  Overview
                </button>
                <button 
                  data-tour="tab-ecosystem"
                  ...
                  style={{ 
                    fontFamily: 'Montserrat Alternates',
                    fontWeight: activeTab === 'ecosystem' ? 600 : 500,
                    background: activeTab === 'ecosystem' 
                      ? 'linear-gradient(135deg, rgba(0, 169, 157, 0.95) 0%, rgba(13, 120, 113, 0.95) 100%)'
                      : 'transparent',
                    color: activeTab === 'ecosystem' ? 'white' : '#4a4642',
                  }}
                >
                  Ecosystem
                </button>
                <button 
                  ...
                  style={{ 
                    ...
                    background: activeTab === 'links' 
                      ? 'linear-gradient(135deg, rgba(0, 169, 157, 0.95) 0%, rgba(13, 120, 113, 0.95) 100%)'
                      : 'transparent',
                    color: activeTab === 'links' ? 'white' : '#4a4642',
                  }}
                >
                  Links
                </button>
                <button 
                  data-tour="tab-actions"
                  ...
                  style={{ 
                    ...
                    background: activeTab === 'actions' 
                      ? 'linear-gradient(135deg, rgba(0, 169, 157, 0.95) 0%, rgba(13, 120, 113, 0.95) 100%)'
                      : 'transparent',
                    color: activeTab === 'actions' ? 'white' : '#4a4642',
                  }}
                >
                  Action Items
                </button>
              ...
              <div className="p-6" style={{ background: 'rgba(255, 255, 255, 0.6)', borderRadius: '0 0 20px 20px' }} role="tabpanel">
                {/* Edit/Save/Cancel Buttons */}
                <div className="flex justify-end mb-4">
                  {!isEditing ? (
                    <button 
                      onClick={() => setIsEditing(true)} 
                      className="flex items-center gap-2 px-4 py-2 text-sm text-[#db2777] hover:bg-[#db2777]/10 rounded-xl transition" 
                ...
                {activeTab === 'overview' && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg text-[#1a1a1a] mb-3" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                        Trunk (Page Intent)
                      </h3>
                      {isEditing ? (
                        <textarea 
                        ...
                        <p className="text-[#1a1a1a]/80 leading-relaxed" style={{ fontFamily: 'Inter', fontWeight: 500 }}>
                    ...
                    {(mapData.leaves && mapData.leaves.length > 0) && (
                      <div>
                        <h3 className="text-base text-[#1a1a1a] mb-3 flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                        ...
                        <div className="space-y-2">
                          {mapData.leaves.map((leaf: LeafItem, i: number) => (
                            ...
                            >
                              <h4 className="text-sm font-semibold text-[#1a1a1a] mb-1" style={{ fontFamily: 'Inter' }}>
                                {leaf.title}
                              </h4>
                              <p className="text-xs text-[#1a1a1a]/70" style={{ fontFamily: 'Inter' }}>
                                {leaf.description}
                              </p>
                            </div>
                          ))}
                ...
                {activeTab === 'ecosystem' && (
                  <div className="space-y-6">
                    {/* Roots - Core Concepts */}
                    <div>
                      <h3 className="text-sm text-[#166534] mb-3 flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {!isEditing && (mapData.roots || []).length === 0 && (
                          <span className="text-[#6b6560] text-sm italic">No root concepts defined</span>
                        )}
                      </div>
                    </div>
                    ...
                    <div>
                      <h3 className="text-sm text-[#006b63] mb-3 flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {!isEditing && (mapData.branches || []).length === 0 && (
                          <span className="text-[#6b6560] text-sm italic">No supporting topics defined</span>
                        )}
                      </div>
                    </div>
                    ...
                    {/* Soil - Anchor Text */}
                    <div>
                      <h3 className="text-sm text-[#365314] mb-3 flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(isEditing ? editedSoil : (mapData.soil || [])).map((text: string, i: number) => (
                          <span 
                            key={i} 
                            className="px-3 py-1.5 rounded-lg text-sm flex items-center gap-2 group cursor-pointer"
                            style={{ 
                              fontFamily: 'Inter', 
                              fontWeight: 500,
                        ...
                        {!isEditing && (mapData.soil || []).length === 0 && (
                          <span className="text-[#6b6560] text-sm italic">No anchor text phrases defined</span>
                        )}
                      </div>
                    </div>
                    ...
                    {/* Fruit - Proof Points */}
                    <div>
                      <h3 className="text-sm text-[#db2777] mb-3 flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                        ...
                        {(isEditing ? editedFruitKeywords : (mapData.fruit || [])).map((item: string, i: number) => {
                          ...
                          return (
                            <div 
                              ...
                              style={{
                                background: isSuggestion ? 'rgba(219, 39, 119, 0.06)' : 'rgba(219, 39, 119, 0.1)',
                                border: isSuggestion ? '1px dashed rgba(219, 39, 119, 0.3)' : '1px solid rgba(219, 39, 119, 0.2)',
                              }}
                            >
                              {isSuggestion && (
                                <span 
                                  className="shrink-0 px-2 py-0.5 rounded text-[10px] font-semibold uppercase"
                                  style={{ background: 'rgba(219, 39, 119, 0.15)', color: '#be185d' }}
                                >
                                  Suggestion
                                </span>
                              )}
                              <span className="flex-1 text-sm text-[#1a1a1a]" style={{ fontFamily: 'Inter', fontWeight: 500 }}>
                                {displayText}
                              </span>
                              {isEditing && (
                                <button onClick={() => removeKeyword('fruit', i)} className="text-[#6b6560] hover:text-red-500">×</button>
                              )}
                            </div>
                          );
                        })}
                        {!isEditing && (mapData.fruit || []).length === 0 && (
                          <p className="text-[#6b6560] text-sm italic">No proof points defined</p>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                {activeTab === 'links' && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-sm text-[#7c3aed] mb-3 flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                      ...
                      <div className="space-y-2">
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-start gap-2">
                                ...
                                <div className="flex-1">
                                  <p className="text-sm font-medium text-[#1a1a1a]" style={{ fontFamily: 'Inter' }}>
                                    {link.title}
                                  </p>
                                  {link.reason && (
                                    <p className="text-xs text-[#4a4642] mt-1" style={{ fontFamily: 'Inter' }}>
                                      {link.reason}
                                    </p>
                                  )}
                                </div>
                                {isEditing && (
                                  <button 
                                    ...
                                    className="text-[#6b6560] hover:text-red-500"
                                  >
                                    ×
                                  </button>
                                )}
                        ...
                        {!isEditing && (mapData.underground_network || []).length === 0 && (
                          <p className="text-[#6b6560] text-sm italic">No internal link suggestions</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div>
                      <h3 className="text-sm text-[#a21caf] mb-3 flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                      ...
                      <div className="space-y-2">
                        {(isEditing ? editedExternalLinks : (mapData.pollinators || [])).map((item: any, i: number) => {
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-start gap-2">
                                <svg className="w-4 h-4 text-[#a21caf] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex-1">
                                  ...
                                  {link.url && (
                                    <a 
                                      ...
                                      target="_blank" 
                                      rel="noopener noreferrer"
                                      className="text-xs text-[#a21caf] hover:underline mt-1 block"
                                    >
                                      {link.url}
                                    </a>
                                  )}
                        ...
                        {!isEditing && (mapData.pollinators || []).length === 0 && (
                          <p className="text-[#6b6560] text-sm italic">No external link suggestions</p>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                {activeTab === 'actions' && (
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg text-[#1a1a1a] flex items-center gap-2" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
                        <span className="text-lg">✅</span> Cultivation Plan
                      </h3>
                      <div className="flex items-center gap-4">
                        <span className="text-sm text-[#006b63] font-medium" style={{ fontFamily: 'Inter' }}>
                    ...
                    {todoSuccess && (
                      ...
                      >
                        ...
                        <a href="/to-do" className="ml-auto text-sm underline hover:no-underline">View To-Dos →</a>
                      </div>
                    )}
                    ...
                    {(isEditing ? editedActions : (mapData.cultivation_plan || [])).length > 0 ? (
                            ...
                            >
                              {!isEditing && (
                                <input 
                                  ...
                                  className="mt-0.5 w-5 h-5 rounded border-2 border-[#dedede] text-[#006b63] focus:ring-[#00A99D] cursor-pointer" 
                                />
                              )}
                              {isEditing ? (
                      ...
                      <p className="text-[#6b6560] text-center py-8" style={{ fontFamily: 'Inter', fontWeight: 500 }}>
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <h3 className="text-2xl text-[#1a1a1a] mb-4 text-center" style={{ fontFamily: 'Montserrat Alternates', fontWeight: 600 }}>
              Delete Project?
            </h3>
            <p className="text-[#1a1a1a]/70 mb-6 text-center" style={{ fontFamily: 'Inter', fontWeight: 500 }}>
              Are you sure you want to delete "<strong className="text-[#1a1a1a]">{getProjectName()}</strong>"? 
      ...
      {isFullscreen && (project?.pdf_url || project?.browser_url) && (
        <div className="fixed inset-0 z-50 bg-black/90 flex flex-col">
          ...
          <div className="flex-1">
            <iframe
              src={`${project.browser_url || project.pdf_url}#toolbar=1&navpanes=0&view=FitH`}
      ...
      {showTour && (
        <PageTour
          ...
          onAction={(action) => {
            switch (action) {
              case 'switchToOverview':
                setActiveTab('overview');
                break;
              case 'switchToEcosystem':
